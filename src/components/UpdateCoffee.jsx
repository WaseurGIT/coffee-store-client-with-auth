  ...
  return (
    <div>
      ...
      <form
        ...
        className="text-center w-[850px] mt-12 mx-auto"
      >
        <div>
          <fieldset className="fieldset w-[850px] bg-base-200 border border-base-300 p-4 rounded-box">
            <legend className="fieldset-legend font-semibold text-xl">
              Update Coffee
            </legend>
            ...
            <div className="my-3 md:grid grid-cols-2 gap-3">
              <div>
                ...
                <label className="my-2 font-bold fieldset-label">
                  Supplier
                </label>
                <input
                  type="text"
            ...
            <input
              type="submit"
              value="Update Coffee"
              className="font-semibold text-xl bg-[#D2B48C] h-[50px] rounded-lg btn"
            />
          </fieldset>
        </div>
      </form>
